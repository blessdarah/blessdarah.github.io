                ...
                <div className="px-10 mx-auto max-w-7xl">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className="max-w-sm mb-16 lg:mb-0 lg:max-w-2xl lg:w-1/2 lg:px-4">
                            ...
                            <h2 className="mb-4 text-4xl font-bold tracking-tight lg:text-6xl xl:text-7xl">Sign up today and start learning</h2>
                            <p className="mb-8 leading-loose text-gray-500">This is your chance to become something you've been dreaming of. Create your account now and get started with your learning journey</p>
                        </div>
