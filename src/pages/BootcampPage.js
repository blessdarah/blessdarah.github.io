            ...
            <section className="h-auto bg-white">
                <div className="px-10 py-24 mx-auto max-w-7xl">
                    <div className="w-full mx-auto text-left md:text-center">
                        <h1 className="mb-6 text-5xl font-extrabold leading-none max-w-5xl mx-auto tracking-normal text-gray-900 sm:text-6xl md:text-6xl lg:text-7xl md:tracking-tight"> Become <span className="w-full text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 lg:inline">A Frontend Developer</span><br className="lg:block hidden" /> In 12 Weeks.</h1>
                        <p className="px-0 mb-6 text-lg text-gray-600 md:text-xl lg:px-24">Join our frontend development bootcamp coming next month to learn the skills you need to become a frontend developer</p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="relative flex flex-col items-start justify-center w-full max-w-sm px-5 mx-auto mb-20 lg:max-w-none md:max-w-md md:px-0 lg:mb-0 lg:w-5/12">
                        ...
                        <ol className="mb-8 space-y-6 text-gray-500 lg:space-y-10 lg:pr-10">
                            <li className="flex flex-col items-start space-y-2 lg:flex-row lg:items-center lg:space-x-3 lg:space-y-0">
                                <span className="flex items-center justify-start flex-shrink-0 w-20 h-8 text-sm font-semibold text-indigo-500 rounded-full lg:w-10 lg:h-10 lg:bg-gray-100 lg:text-base lg:text-gray-500 lg:font-normal lg:justify-center">
                                    <span className="inline-block mr-1 lg:hidden">Step</span> 1
                                </span>
                                <span>If you have been eager to learn how to build websites and stand the chance of having a job in the industry</span>
                            </li>
                            <li className="flex flex-col items-start space-y-2 lg:flex-row lg:items-center lg:space-x-3 lg:space-y-0">
                                <span className="flex items-center justify-start flex-shrink-0 w-20 h-8 text-sm font-semibold text-indigo-500 rounded-full lg:w-10 lg:h-10 lg:bg-gray-100 lg:text-base lg:text-gray-500 lg:font-normal lg:justify-center">
                                    <span className="inline-block mr-1 lg:hidden">Step</span> 2
                                </span>
                                <span>Anyone who want to improve his/her skills in becoming a world-class frontend developer.</span>
                            </li>
                            <li className="flex flex-col items-start space-y-2 lg:flex-row lg:items-center lg:space-x-3 lg:space-y-0">
                                <span className="flex items-center justify-start flex-shrink-0 w-20 h-8 text-sm font-semibold text-indigo-500 rounded-full lg:w-10 lg:h-10 lg:bg-gray-100 lg:text-base lg:text-gray-500 lg:font-normal lg:justify-center">
                ...
                <div className="relative px-12 mx-auto w-full max-w-7xl text-gray-900 box-border">
                    <div className="flex flex-wrap -mx-5 mt-0 box-border">
                        <div className="relative flex-none px-5 mt-0 w-full max-w-full md:w-1/3 md:flex-none box-border">
                            ...
                            <h3 className="mt-0 mb-2 text-xl tracking-normal box-border"> Beginner Friendly </h3>
                            <p className="mt-0 mb-8 md:mb-0 box-border text-slate-400">This program is tailored with beginners in mind and it designed to teach you the skills you need to become a frontend developer. Everthing will be taken from the ground up, with live classes and interative projects that should validate your understanding of concepts</p>
                        </div>
                        <div className="relative flex-none px-5 mt-0 w-full max-w-full md:w-1/3 md:flex-none box-border">
                            <div className="mb-3">
                                <img className="w-16 h-16 -ml-1" src="https://cdn.devdojo.com/images/march2022/brush.png" />
                            </div>
                            <h3 className="mt-0 mb-2 text-xl tracking-normal box-border"> UI best practices </h3>
                            <p className="mt-0 mb-8 md:mb-0 box-border text-gray-400">You will not only be taught on what to do, you will also be taught on the best practices to adopt in building websites that are responsive, user friendly and interactive.</p>
                        </div>
                        <div className="relative flex-none px-5 mt-0 w-full max-w-full md:w-1/3 md:flex-none box-border">
                            <div className="mb-3">
                                <img className="w-16 h-16 -ml-1" src="https://cdn.devdojo.com/images/march2022/cloud.png" />
                            </div>
                            <h3 className="mt-0 mb-2 text-xl font-normal tracking-normal box-border"> Build your own portfilio </h3>
                            <p className="my-0 box-border text-slate-400">Establish your presence on the web by building your very own portfolio website from the ground up and deploy on the server for free</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative px-6 py-8 ml-auto mr-auto bg-top bg-cover sm:py-16 max-w-7xl md:px-24 lg:px-16 lg:py-20">
                        ...
                        <div className="relative grid gap-6 bg-top bg-cover sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="flex flex-col items-start justify-between p-6 space-y-4 overflow-hidden transition-shadow duration-200 bg-white bg-top bg-cover border border-gray-100 shadow-xl rounded-2xl group hover:shadow-2xl">
                                <div className="flex items-center justify-center w-10 h-10 text-center bg-top bg-cover rounded-full bg-indigo-50">
                                    <p className="relative">
                                        <svg className="w-5 h-5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd"></path></svg>
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col items-start justify-between p-6 space-y-4 overflow-hidden transition-shadow duration-200 bg-white bg-top bg-cover border border-gray-100 shadow-xl rounded-2xl group hover:shadow-2xl">
                                <div className="flex items-center justify-center w-10 h-10 text-center bg-top bg-cover rounded-full bg-indigo-50">
                                    <p className="relative">
                                        <svg className="w-5 h-5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm9 4a1 1 0 10-2 0v6a1 1 0 102 0V7zm-3 2a1 1 0 10-2 0v4a1 1 0 102 0V9zm-3 3a1 1 0 10-2 0v1a1 1 0 102 0v-1z" clipRule="evenodd"></path></svg>
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col items-start justify-between p-6 space-y-4 overflow-hidden transition-shadow duration-200 bg-white bg-top bg-cover border border-gray-100 shadow-xl rounded-2xl group hover:shadow-2xl">
                                <div className="flex items-center justify-center w-10 h-10 text-center bg-top bg-cover rounded-full bg-indigo-50">
                                    <p className="relative">
                                        <svg className="w-5 h-5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 01-.293.707L12 11.414V15a1 1 0 01-.293.707l-2 2A1 1 0 018 17v-5.586L3.293 6.707A1 1 0 013 6V3z" clipRule="evenodd"></path></svg>
                                    </p>
                                </div>
