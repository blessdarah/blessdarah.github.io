        ...
        <>
            <section className="w-full py-16 pb-20 bg-white">
                <div className="container px-8 mx-auto sm:px-12 lg:px-20">
                    <h1 className="mb-3 text-3xl font-bold leading-tight text-center text-gray-900 md:text-4xl">Trusted by over 850 companies</h1>
                    ...
                    <div className="flex items-center justify-center w-full ml-2">
                        <a href="#" className="flex items-center">
                            <span className="border-b-2 border-black">Visit Our Testimonials</span>
                            <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 ml-1"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </a>
                    </div>
                </div>
            </section>
