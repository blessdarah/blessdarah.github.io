                ...
                <div className="grid gap-5 lg:grid-cols-2">
                    <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                        ...
                        <div className="max-w-xl mb-6">
                            <div className="mb-6">
                                <p className="inline font-sans text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl sm:leading-none">Beautiful designs </p>
                                <p className="block font-sans text-5xl font-bold tracking-tight text-purple-700 sm:text-6xl sm:leading-none">to help you shine.</p>
                            </div>
                            <p className="text-base text-gray-700 md:text-lg">We have hand-crafted beautiful designs that will help your product or service shine. Drag'n drop templates that allow you to build amazing landing pages in seconds!</p>
                        </div>
                        <div className="max-w-xl mb-6">
                    ...
                    <div className="flex justify-center w-full lg:items-center">
                        <div className="flex flex-col items-end pr-3">
                            <img src="https://cdn.devdojo.com/images/july2021/content-19-1.jpg" className="object-cover w-full h-full mb-6 rounded shadow-lg lg:h-48 xl:h-56 lg:w-48 xl:w-56" />
                            <img src="https://cdn.devdojo.com/images/july2021/content-19-2.jpg" className="object-cover w-full h-full rounded shadow-lg lg:h-32 xl:h-40 lg:w-32 xl:w-40" />
                        </div>
                        <div className="pl-3">
                            <img src="https://cdn.devdojo.com/images/july2021/content-19-3.jpg" className="object-cover w-full h-full rounded shadow-lg lg:h-64 xl:h-80 lg:w-64 xl:w-80" />
                        </div>
                    </div>
                </div>
            </div>
