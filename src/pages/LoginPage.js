                                ...
                                <div className="overflow-hidden text-center bg-white rounded-md shadow-sm">
                                    <div className="px-6 py-8">
                                        <form onsubmit="event.preventDefault();">
                                            ...
                                            <button className="w-full py-3 mb-4 font-bold text-white bg-indigo-600 rounded hover:bg-indigo-500">Login</button>
                                        </form>
                                        <p className="text-xs text-gray-400">
                                            <span>Don't have an account?</span>
                                            <Link className="text-indigo-500" to={ROUTES.LOGIN}>Sign up</Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
